# RailsAdmin config file. Generated on September 09, 2012 17:35
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['App Agencies', 'Admin']
  ...
  # config.excluded_models = [Company, Location, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Company, Location, User]
  ...
  #     configure :region, :string   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
  ...
  #   # Found associations:
  #     configure :company, :has_one_association   #   # Found columns:
  #     configure :_type, :text         # Hidden
  #     configure :_id, :bson_object_id
